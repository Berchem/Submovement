...
%  Modified by Yen-Hsun Wu, The Penn. State University (July 05, 2011)
%
...
%  4)  As the Butterworth filter is applied in forward and reverse directions (zero-lag) its order is effectively doubled.
%
